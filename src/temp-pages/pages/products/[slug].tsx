...
import type {
  ProductMediaSlide,
  ProductMediaSlideImage,
  ProductMediaSlideVideo,
    ...
    >
      ...
      >
        <Container maxWidth="lg">
          <Typography color="textPrimary" sx={{ mb: 4 }} variant="h4">
            {product.title}
          </Typography>
