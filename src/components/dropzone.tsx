...
const DropzoneRoot = styled('div')(({ theme }) => ({
  ...
  cursor: 'pointer',
  '&:hover': {
    backgroundColor: theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.12)' : '#EBEBEB',
  }
}))
      ...
      (async () => {
        ...
        if (resolution && onError) {
          ...
          await new Promise((res) => {
            ...
            img.onload = () => {
              if (resolution?.width !== img.naturalWidth || resolution?.height !== img.naturalHeight) {
